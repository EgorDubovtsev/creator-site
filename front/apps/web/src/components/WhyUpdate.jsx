    ...
    <section className="relative bg-[#020617] px-6 py-40 text-white">
      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        ...
        <div className="grid gap-16 md:grid-cols-2">
          ...
          >
            <p>
              Вы уже инвестируете в рекламу, трафик и продвижение. Но
              значительная часть этих вложений не окупается.
            </p>

            <p>
              Причина чаще всего не в маркетинге, а в сайте. Именно он
              превращает посетителя в клиента — или теряет его.
            </p>
          ...
          >
            <p>
              Обновление сайта — это не редизайн ради визуала. Это пересборка
              всей логики взаимодействия с клиентом.
            </p>
            ...
            <p>Это системное улучшение бизнеса, а не разовая доработка.</p>
          </motion.div>
        </div>
